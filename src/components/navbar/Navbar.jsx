  ...
  return (
    <div className='bg-white sticky top-0 z-50'>
      ...
      <header className="relative bg-white">
        <p className="flex h-10 items-center justify-center bg-[#fbae38] px-4 text-sm font-medium text-white sm:px-6 lg:px-8" 
        style={{ backgroundColor: mode === 'dark' ? 'rgb(62 64 66)' : '', color: mode === 'dark' ? 'white' : '', }}>
          Lightron.Pk gives 100% autrhentic lights with affordable prize
        </p>
